...
<body>
    ...
    <main>
        ...
        <section class="main-body">
            ...
            <p>&nbsp;</p>
            <div class="first-box">
       	근처스럽나요? 근처 크루는 종종 이렇게 묻곤 합니다.<br>
                우리의 관점, 행동하는 방법, 지향하는 목표까지 근처스러움은<br>
                이미 우리 안에 스며들어 있습니다. 우리가 더 나은 세상을 만들기 위해<br>
                고민하면서 자연스럽게 체득한 태도이자 본질이기 때문입니다.<br>
            ...
            <div class="second-box">
                근처는 운동시설을 쉽게  검색해 빠르게<br>
                이용할 수 있는 어플리케이션으로<br>
            ...
            <p>&nbsp;</p>
            <div class="thrid-box">
       	간편하게 앱에서 결제하고 바로 운동<br>
		운동을 막상 시작하려면 운동시설을 찾아봐야하고<br>
                전화해서 물어봐야하고 찾아가서 상담까지 받아야하는<br>
                등 할 일이 너무 많았습니다. 이젠 근처에서 복잡한 절차없이<br>
                간편하게 찾고, 바로 운동하세요!
            </div>
            <div class="thrid-img">
