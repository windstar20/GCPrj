package gc.controller.api.point.charge;
...
@WebServlet("/api/product-order/point-charge-list-sort")
public class ListSortController extends HttpServlet{
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	      ...
	      response.setContentType("text/json; charset=UTF-8");
			...
			List<PointChargingView> list = service.getViewList(page, size, field, query, startDate, endDate, sortField,sortOption);
