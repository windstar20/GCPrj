...
@WebServlet("/api/product-order/point-use-list-sort")
public class ListSortController extends HttpServlet{
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	      ...
	      int page=1; // 페이지 번호
			...
			List<PointUseView> list = service1.getViewList(page, size, field, query, startDate, endDate, sortField,sortOption);
